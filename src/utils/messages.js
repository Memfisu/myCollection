...
export const COLLECTION_REMOVE_MODAL_TEXT = (title) => `Do you really want to remove collection ${title}?`
export const COLLECTION_SEARCH_PLACEHOLDER = 'Search item'
export const COLLECTIONS_LIST_EMPTY_TEXT = 'There are no items yet. Add a new one!'
...
export const HOME_SCREEN_LIST_EMPTY_TEXT = 'There are no collections yet. Add a new one!'
export const HOME_SCREEN_ADD_BUTTON_LABEL = 'Add collection'

// ItemViewScreen.js
export const ITEM_REMOVE_MODAL_TEXT = (title) => `Do you really want to remove item ${title}?`
